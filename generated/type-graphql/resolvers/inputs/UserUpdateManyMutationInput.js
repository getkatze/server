...
__decorate(
  [
    TypeGraphQL.Field(
      (_type) => StringFieldUpdateOperationsInput_1.StringFieldUpdateOperationsInput,
      {
        nullable: true,
      }
    ),
  ...
  UserUpdateManyMutationInput.prototype,
  'id',
  void 0
);
__decorate(
  [
    TypeGraphQL.Field(
      (_type) => DateTimeFieldUpdateOperationsInput_1.DateTimeFieldUpdateOperationsInput,
      {
        nullable: true,
      }
    ),
    __metadata(
      'design:type',
      DateTimeFieldUpdateOperationsInput_1.DateTimeFieldUpdateOperationsInput
    ),
  ],
  UserUpdateManyMutationInput.prototype,
  'createdAt',
